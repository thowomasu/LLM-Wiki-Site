...
- It does not let proxy-rich all-protocol scores override the locked R0-versus-DRT comparison.
...
The sharpest DRT-specific check is combined DRT mirror check: R0 only versus DRT bands without R0 versus R0 plus DRT bands.
